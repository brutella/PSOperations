Pod::Spec.new do |s|
	...
	s.homepage	= "https://github.com/brutella/PSOperations"
	s.license	= { :type => 'MIT' }
	s.author	= "Matthias Hochgatterer"
	...
	s.source = {  git: "https://github.com/brutella/PSOperations.git",  tag: s.version.to_s  }
